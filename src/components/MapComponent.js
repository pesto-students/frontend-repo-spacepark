...
const MapComponent = () => {
  ...
  return (
    <Container fluid>
      <Row>
        <Col md={6} className="d-flex flex-column align-items-center justify-content-center linear-color" >
          <SearchComponent />
          <Card />
        </Col>
        <Col md={6}>
          <MapContainer center={[28.6139, 77.2090]} zoom={5} style={{ height: '100vh' }}>
            <TileLayer
            ...
            {locationState && (
              <Marker position={[locationState.lat, locationState.lng]} icon={customIcon}>
